...
import cn.edu.tju.mapper.OrderItemMapper;
import cn.edu.tju.mapper.OrderMapper;
import cn.edu.tju.mapper.PayInfoMapper;
...
public class PayServiceImpl implements PayService {
    ...
    public ServerResponse pay(Long orderNo, Integer userId, String path) {
        ...
        String subject = new StringBuilder().append("CMWMall扫码支付,订单号:").append(outTradeNo).toString();
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                String qrUrl = PropertiesUtil.getProperty("ftp.server.qr.http.prefix")+targetFile.getName();
    ...
    public ServerResponse aliCallback(Map<String, String> params) {
        ...
        if(order == null){
            return ServerResponse.createByErrorMessage("非CMWMall的订单,回调忽略");
        }
